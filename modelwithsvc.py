...
pred2=svc.predict(X_validation)
print("accuracy_score:",accuracy_score(Y_validation, pred2))
print("confusion_matrix:\n",confusion_matrix(Y_validation, pred2))
print("classification_report:\n",classification_report(Y_validation, pred2))
pred=svc.predict([funcs(matrixdondur("output6.avi"))])
print("svc predict:",pred)
